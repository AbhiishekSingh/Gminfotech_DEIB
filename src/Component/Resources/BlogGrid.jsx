...
const blogs = [
  {
    title: "How to Build an Inclusive Workplace Culture in India",
    image: "https://s3.us-east-1.amazonaws.com/peoplism.s8/hero/_408x280_fit_center-center_none/manager.jpg",
  },
  {
    title: "5 Steps to Remove Bias from Performance Reviews ",
  ...
  {
    title: "Employee Resource Groups (ERGs) in Indian Workplaces: Best Practices",
  ...
  {
    title: "DEIB Trends for 2025: What Indian Companies Need to Know ",
  ...
  {
    title: "How Psychological Safety Drives Innovation & Productivity ",
